...
drop sumHaz 
replace haz1 = exp(xb1 + 0.5) if inProg
replace haz2 = exp(xb2 - 0.2) if inProg
egen sumHaz = rowtotal(haz1 haz2) if inProg
...
br id t trans inProg cause failure exit _exit 
